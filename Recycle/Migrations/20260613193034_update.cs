#pragma warning disable CS8981 // legacy migration name; renaming a shipped migration is riskier than the warning
using System;
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Otps_Machines_MachineId",
